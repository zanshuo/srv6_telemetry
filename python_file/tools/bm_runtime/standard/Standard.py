...
class Iface:
  ...
  def bm_parse_vset_get(self, cxt_id, parse_vset_name):
    """
    Parameters:
     - cxt_id
     - parse_vset_name
...
class Client(Iface):
  ...
  def bm_parse_vset_get(self, cxt_id, parse_vset_name):
    ...
    Parameters:
     ...
     - parse_vset_name
    """
    self.send_bm_parse_vset_get(cxt_id, parse_vset_name)
  ...
  def recv_bm_parse_vset_get(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
  ...
  def bm_parse_vset_clear(self, cxt_id, parse_vset_name):
    ...
    Parameters:
     ...
     - parse_vset_name
    """
    self.send_bm_parse_vset_clear(cxt_id, parse_vset_name)
  ...
  def recv_bm_parse_vset_clear(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = bm_parse_vset_clear_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.ouch is not None:
      raise result.ouch
...
class Processor(Iface, TProcessor):
  ...
  def process_bm_parse_vset_get(self, seqid, iprot, oprot):
    args = bm_parse_vset_get_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = bm_parse_vset_get_result()
    try:
      ...
      result.ouch = ouch
    oprot.writeMessageBegin("bm_parse_vset_get", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_bm_parse_vset_clear(self, seqid, iprot, oprot):
    args = bm_parse_vset_clear_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = bm_parse_vset_clear_result()
    try:
      self._handler.bm_parse_vset_clear(args.cxt_id, args.parse_vset_name)
    except InvalidParseVSetOperation, ouch:
      result.ouch = ouch
    oprot.writeMessageBegin("bm_parse_vset_clear", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class bm_mt_reset_default_entry_args:
  """
  Attributes:
   - cxt_id
   - table_name
...
class bm_mt_reset_default_entry_result:
  """
  Attributes:
   - ouch
  """
...
class bm_mt_act_prof_add_member_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I32, 'cxt_id', None, None, ), # 1
    (2, TType.STRING, 'act_prof_name', None, None, ), # 2
    (3, TType.STRING, 'action_name', None, None, ), # 3
    (4, TType.LIST, 'action_data', (TType.STRING,None), None, ), # 4
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.act_prof_name = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.act_prof_name is not None:
      ...
      oprot.writeString(self.act_prof_name)
      oprot.writeFieldEnd()
    if self.action_name is not None:
      oprot.writeFieldBegin('action_name', TType.STRING, 3)
      oprot.writeString(self.action_name)
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.cxt_id)
    value = (value * 31) ^ hash(self.act_prof_name)
    value = (value * 31) ^ hash(self.action_name)
    value = (value * 31) ^ hash(self.action_data)
    return value
...
class bm_mt_act_prof_add_member_result:
  """
  Attributes:
   - success
   - ouch
...
class bm_mt_act_prof_delete_member_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_delete_member_result:
  """
  Attributes:
   - ouch
  """
...
class bm_mt_act_prof_modify_member_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_modify_member_result:
  """
  Attributes:
   - ouch
  """
...
class bm_mt_act_prof_create_group_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_create_group_result:
  """
  Attributes:
   - success
   - ouch
...
class bm_mt_act_prof_delete_group_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_delete_group_result:
  """
  Attributes:
   - ouch
  """
...
class bm_mt_act_prof_add_member_to_group_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_add_member_to_group_result:
  """
  Attributes:
   - ouch
  """
...
class bm_mt_act_prof_remove_member_from_group_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_remove_member_from_group_result:
  """
  Attributes:
   - ouch
  """
...
class bm_mt_act_prof_get_members_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_get_members_result:
  """
  Attributes:
   - success
   - ouch
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(BmMtActProfMember, BmMtActProfMember.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'ouch', (InvalidTableOperation, InvalidTableOperation.thrift_spec), None, ), # 1
  )
...
class bm_mt_act_prof_get_member_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_get_member_result:
  """
  Attributes:
   - success
   - ouch
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (BmMtActProfMember, BmMtActProfMember.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'ouch', (InvalidTableOperation, InvalidTableOperation.thrift_spec), None, ), # 1
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = BmMtActProfMember()
...
class bm_mt_act_prof_get_groups_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_get_groups_result:
  """
  Attributes:
   - success
   - ouch
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(BmMtActProfGroup, BmMtActProfGroup.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'ouch', (InvalidTableOperation, InvalidTableOperation.thrift_spec), None, ), # 1
  )
...
class bm_mt_act_prof_get_group_args:
  """
  Attributes:
   - cxt_id
   - act_prof_name
...
class bm_mt_act_prof_get_group_result:
  """
  Attributes:
   - success
   - ouch
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (BmMtActProfGroup, BmMtActProfGroup.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'ouch', (InvalidTableOperation, InvalidTableOperation.thrift_spec), None, ), # 1
  )
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i97 in xrange(_size93):
            _elem98 = BmMatchParam()
            _elem98.read(iprot)
            self.match_key.append(_elem98)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
...
class bm_mt_indirect_reset_default_entry_args:
  """
  Attributes:
   - cxt_id
   - table_name
...
class bm_mt_indirect_reset_default_entry_result:
  """
  Attributes:
   - ouch
  """
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i104 in xrange(_size100):
            _elem105 = BmMatchParam()
            _elem105.read(iprot)
            self.match_key.append(_elem105)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i111 in xrange(_size107):
            _elem112 = BmMeterRateConfig()
            _elem112.read(iprot)
            self.rates.append(_elem112)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i132 in xrange(_size128):
            _elem133 = BmMatchParam()
            _elem133.read(iprot)
            self.match_key.append(_elem133)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
...
class bm_parse_vset_get_result:
  """
  Attributes:
   - success
   - ouch
...
class bm_parse_vset_clear_args:
  """
  Attributes:
   - cxt_id
   - parse_vset_name
...
class bm_parse_vset_clear_result:
  """
  Attributes:
   - ouch
  """
...
class bm_get_id_from_name_args:
  """
  Attributes:
   - cxt_id
   - resource_type
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'resource_name', None, None, ), # 3
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.cxt_id)
    value = (value * 31) ^ hash(self.resource_type)
...
class bm_get_id_from_name_result:
  """
  Attributes:
   - success
   - ouch
  ...
  thrift_spec = (
    (0, TType.I32, 'success', None, None, ), # 0
    (1, TType.STRUCT, 'ouch', (InvalidIdLookup, InvalidIdLookup.thrift_spec), None, ), # 1
  )
