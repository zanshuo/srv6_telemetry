...
try:
  ...
  class P4RuntimeStub(object):
    ...
    def __init__(self, channel):
      ...
      self.Capabilities = channel.unary_unary(
          ...
          request_serializer=CapabilitiesRequest.SerializeToString,
          response_deserializer=CapabilitiesResponse.FromString,
          )
  ...
  def add_P4RuntimeServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'Capabilities': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=CapabilitiesRequest.FromString,
            response_serializer=CapabilitiesResponse.SerializeToString,
        ),
    }
  ...
  def beta_create_P4Runtime_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('p4.v1.P4Runtime', 'Capabilities'): CapabilitiesRequest.FromString,
      ('p4.v1.P4Runtime', 'GetForwardingPipelineConfig'): GetForwardingPipelineConfigRequest.FromString,
      ('p4.v1.P4Runtime', 'Read'): ReadRequest.FromString,
      ('p4.v1.P4Runtime', 'SetForwardingPipelineConfig'): SetForwardingPipelineConfigRequest.FromString,
      ('p4.v1.P4Runtime', 'StreamChannel'): StreamMessageRequest.FromString,
      ('p4.v1.P4Runtime', 'Write'): WriteRequest.FromString,
    }
    response_serializers = {
      ('p4.v1.P4Runtime', 'Capabilities'): CapabilitiesResponse.SerializeToString,
      ('p4.v1.P4Runtime', 'GetForwardingPipelineConfig'): GetForwardingPipelineConfigResponse.SerializeToString,
      ('p4.v1.P4Runtime', 'Read'): ReadResponse.SerializeToString,
      ('p4.v1.P4Runtime', 'SetForwardingPipelineConfig'): SetForwardingPipelineConfigResponse.SerializeToString,
      ('p4.v1.P4Runtime', 'StreamChannel'): StreamMessageResponse.SerializeToString,
      ('p4.v1.P4Runtime', 'Write'): WriteResponse.SerializeToString,
    }
    method_implementations = {
      ('p4.v1.P4Runtime', 'Capabilities'): face_utilities.unary_unary_inline(servicer.Capabilities),
      ('p4.v1.P4Runtime', 'GetForwardingPipelineConfig'): face_utilities.unary_unary_inline(servicer.GetForwardingPipelineConfig),
      ('p4.v1.P4Runtime', 'Read'): face_utilities.unary_stream_inline(servicer.Read),
      ('p4.v1.P4Runtime', 'SetForwardingPipelineConfig'): face_utilities.unary_unary_inline(servicer.SetForwardingPipelineConfig),
      ('p4.v1.P4Runtime', 'StreamChannel'): face_utilities.stream_stream_inline(servicer.StreamChannel),
      ('p4.v1.P4Runtime', 'Write'): face_utilities.unary_unary_inline(servicer.Write),
    }
  ...
  def beta_create_P4Runtime_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('p4.v1.P4Runtime', 'Capabilities'): CapabilitiesRequest.SerializeToString,
      ('p4.v1.P4Runtime', 'GetForwardingPipelineConfig'): GetForwardingPipelineConfigRequest.SerializeToString,
      ('p4.v1.P4Runtime', 'Read'): ReadRequest.SerializeToString,
      ('p4.v1.P4Runtime', 'SetForwardingPipelineConfig'): SetForwardingPipelineConfigRequest.SerializeToString,
      ('p4.v1.P4Runtime', 'StreamChannel'): StreamMessageRequest.SerializeToString,
      ('p4.v1.P4Runtime', 'Write'): WriteRequest.SerializeToString,
    }
    response_deserializers = {
      ('p4.v1.P4Runtime', 'Capabilities'): CapabilitiesResponse.FromString,
      ('p4.v1.P4Runtime', 'GetForwardingPipelineConfig'): GetForwardingPipelineConfigResponse.FromString,
      ('p4.v1.P4Runtime', 'Read'): ReadResponse.FromString,
      ('p4.v1.P4Runtime', 'SetForwardingPipelineConfig'): SetForwardingPipelineConfigResponse.FromString,
      ('p4.v1.P4Runtime', 'StreamChannel'): StreamMessageResponse.FromString,
      ('p4.v1.P4Runtime', 'Write'): WriteResponse.FromString,
    }
    cardinalities = {
    ...
    return beta_implementations.dynamic_stub(channel, 'p4.v1.P4Runtime', cardinalities, options=stub_options)
except ImportError:
  pass
